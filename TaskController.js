class TaskController{
    constructor(taskService, taskList, taskInput, deleteItemEvent, errorBox, htmlErrorFormatter){
       this[_taskService] = taskService;
        this[_taskList] = taskList;
        this[_taskInput] = taskInput;
        this[_deleteItemEvent] = deleteItemEvent;
        this[_errorMessages] = errorBox;
        this[_htmlErrorFormatter] = htmlErrorFormatter;
    }
    ...
    addItemEvent(e){
        ...
        if (!serviceResponse.success){
            this[_errorMessages].innerHTML = this[_htmlErrorFormatter].format(serviceResponse.errors);
